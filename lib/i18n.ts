...
export const ui = {
  ...
  fa: {
    ...
    heroSubtitle:
      "از سیستم‌های RAG با چند provider تا بک‌اندهای مقاوم در برابر خرابی — دربارهٔ هر چیزی که ساختم بپرس.",
    ...
    copy: "کپی",
    copied: "کپی شد",
    poweredBy: "RAG زنده روی رزومهٔ من · جابه‌جایی خودکار بین providerها",
    suggestions: [
      "ScrapeGPT چیه؟",
      "Aigram چیکار می‌کنه؟",
      "تو Dekamond چی ساختی؟",
