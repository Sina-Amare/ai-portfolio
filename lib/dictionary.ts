...
export const dict = {
  en: {
    ...
    work: {
      ...
      description:
        "Two private projects that turned recurring research and reporting work into useful, reviewable results.",
      projectLabel: "Workplace agent",
      problem: "The problem",
      workflow: "What I built",
  ...
  fa: {
    ...
    work: {
      ...
      description:
        "دو پروژهٔ کاری که جمع‌آوری اطلاعات و گزارش‌گیری‌های تکراری رو به نتیجه‌های قابل استفاده تبدیل کردن.",
